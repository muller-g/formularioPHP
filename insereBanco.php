...
$sql = "INSERT INTO formulario (nameC, email, dateNasc, stateBr) VALUES ('$name', '$email', '$date', '$state')";
...
if ($con->query($sql) === TRUE) {
    ...
    echo "<label for='exampleInputEmail1' class='form-label'>Cadastro Efetuado com Sucesso!</label>";
    echo "<br><a class='btn btn-primary' href='index.html'>Voltar</a>";
} else {
